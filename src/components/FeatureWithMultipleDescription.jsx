    ...
    return (
      <div className="bg-white">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 sm:px-6 py-4 lg:py-[2.2rem] xl:py-0 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
            <h2 className="mt-2 text-2xl sm:text-3xl font-bold tracking-tight text-[#020202]">{features[0].heading}</h2>
          ...
          <div className="mt-[8rem] grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
